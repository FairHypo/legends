...
return [
    ...
    */
    ...
    'headline_logo' => '/img/forum-logo.png',
    ...
    */
    ...
    'master_file_extend' => 'layout.mainlayout',
    ...
    */
    ...
    'user' => [
        ...
        'relative_url_to_image_assets'  => '/img/uploads/images/',
    ...
    */
    ...
    'middleware' => [
        ...
        'home'       => [],
        'discussion' => [
            'index'   => ['forum.discussion.index'],
            'show'    => ['forum.discussion.show'],
            'create'  => ['forum.discussion.create'],
            'store'   => ['forum.discussion.store'],
            'destroy' => ['forum.discussion.destroy'],
            'edit'    => ['forum.discussion.edit'],
            'update'  => ['forum.discussion.update'],
        ],
        'post' => [
            'index'   => ['forum.post.index'],
            'show'    => ['forum.post.show'],
            'create'  => ['forum.post.create'],
            'store'   => ['forum.post.store'],
            'destroy' => ['forum.post.destroy'],
            'edit'    => ['forum.post.edit'],
            'update'  => ['forum.post.update'],
        ],
        'category' => [
            'show' => ['forum.category.show'],
        ],
    ],
];
